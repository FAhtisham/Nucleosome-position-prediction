...
def create_loaders(samples_np, labels_np, samples, split_size):
    ...
    train_DataLoader_FD = DataLoader(full_dataset, batch_size = config.batch_size, shuffle = True, sampler = None,
                            batch_sampler = None, num_workers = 0, collate_fn = None,
                            pin_memory = False, drop_last = False, timeout = 0, worker_init_fn = None)
    ...
    return train_DataLoader, test_DataLoader, train_ds, test_ds, train_DataLoader_FD, full_dataset